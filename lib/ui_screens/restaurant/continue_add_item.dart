...
class ContinueAddItem extends StatefulWidget {
  final File image;
  FoodModel foodItem;

  ContinueAddItem({required this.image, required this.foodItem});

  @override
  _ContinueAddItemState createState() => _ContinueAddItemState();
}

class _ContinueAddItemState extends State<ContinueAddItem> {
  ...
  _addItem(BuildContext context) async {
    if (priceList.isNotEmpty){
      ...
      await DatabaseService().addFood(
          newFood: widget.foodItem, imageFile: widget.image);
      BotToast.cleanAll();
